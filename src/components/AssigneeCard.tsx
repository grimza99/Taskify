...
const AssigneeCard: React.FC<AssigneeCardProps> = ({
  ...
  return (
    <div className="tablet:w-[200px] tablet:h-[155px] bg-white rounded-[8px] px-[16px] tablet:py-[13px] py-[6px] border border-[#d9d9d9] flex tablet:flex-col justify-between w-[295px] h-[64px]">
