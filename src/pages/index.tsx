    ...
    <>
      ...
      <main className="dark">
        <div className="dark:bg-black-400 pt-[42px] text-center m-auto flex flex-col justify-center items-center">
          ...
          {/* section02 */}
          <div className="flex flex-col items-center justify-center laptop:justify-between mb-[90px] tablet:mb-[180px] px-[16px] tablet:px-[0] w-full max-w-[1200px] gap-[60px] tablet:gap-[90px]">
            {/* point 1 */}
